...
//        alphaAndBetaStar[0] = Elf64Utils.getDecimalPlaces(v);
//        int[] spAndFlag = Elf64Utils.getSPAnd10iNFlag(Math.abs(v));
//        int theta = spAndFlag[0] + 1;
//        alphaAndBetaStar[1] = spAndFlag[1] == 1 ? 0 : alphaAndBetaStar[0] + theta;
...
//            System.out.println("my: erasing operation duration: " + (System.nanoTime() - start));
//            start = System.nanoTime();

            size += xorCompress(vPrimeLong, lastBetaStar, alphaAndBetaStar[0], deltaEQ0);
...
//            start = System.nanoTime();
            ...
            size += xorCompress(vPrimeLong, -1, alphaAndBetaStar[0], deltaEQ0);

        }
//        System.out.println("my: compress the " + count++ + "-th value: " + (System.nanoTime() - start));
