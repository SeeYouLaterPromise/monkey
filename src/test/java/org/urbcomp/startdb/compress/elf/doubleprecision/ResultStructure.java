...
public class ResultStructure {
    ...
    private double TotalEncodingDuration;
    private double TotalDecodingDuration;
    private float totalBlocks;

    // for average calculation file
...
//        average for per block
    ...
    public ResultStructure(String filename, String compressorName, double compressorRatio, List<Double> compressionTime, List<Double> decompressionTime, float totalBlocks) {
        this.filename = filename;
        this.compressorName = compressorName;
        this.compressorRatio = compressorRatio;
//        average for per block
        ...
        this.TotalEncodingDuration = sumValue(compressionTime);
        this.TotalDecodingDuration = sumValue(decompressionTime);
        this.totalBlocks = totalBlocks;
    }

    private double sumValue(List<Double> ld) {
        double sum = 0;
        for(Double d: ld) {
            sum += d;
        }
    ...
    public float getTotalBlocks() { return totalBlocks; }

    public double getTotalEncodingDuration() { return TotalEncodingDuration; }

    public double getTotalDecodingDuration() { return TotalDecodingDuration; }
